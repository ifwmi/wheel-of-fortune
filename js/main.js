const sectors = [
    ...
    {color:"#EC0CD6", label:"", cashback:'30%'},
...
const playAudio2 = document.querySelector("#audio_play2");
...
const drawSector = (sector, i) => {
    ...
    ctx.textAlign = "right";
    ctx.fillStyle = "#fff";
    ctx.font = "bold 1.3vw sans-serif";
...
const rotate = () => {
    ...
    elSpin.textContent = !angVel ?  "Getforce": sector.label+sector.cashback;
    elSpin.style.background = sector.color;
    elSpin.style.fontSize = "1.5vw";
};
